    ...
    public void play_Clicked(ActionEvent actionEvent) {
        ...
        if(!check(textField_MazeRows)) {
            textField_MazeRows.setStyle("-fx-border-color: #ff381a;"+
                    "-fx-border-width: 2.5;" +
                    "-fx-background-image: url(file:resources/Game/warning.jpg);" +
        ...
        if(play){
            try {
                ...
                gameController.initialize(mainStage,gameScene,myViewModel,characterName,Integer.parseInt(textField_MazeRows.getText()),Integer.parseInt(textField_MazeColumns.getText()));
                mediaPlayer.stop();
            }
