...
public class MazeDisplayer extends Canvas {
    ...
    public void drawMaze() {
        ...
        try {
            Image wallImage = new Image(new FileInputStream("resources\\Grass.png"));
            Image pathImage = new Image(new FileInputStream("resources\\Klum.png"));
            Image endImage = new Image(new FileInputStream("resources\\target.png"));
